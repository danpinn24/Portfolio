      ...
      <div className="about-container">
        ...
        <div className="about-content">
          ...
          <div className="about-text">
            <p>
              ...
              (MySQL, PostgreSQL)</strong>[cite: 1, 3].
            </p>
            ...
            <p>
              ...
              analítica para crear mediaciones ante desafíos complejos[cite: 1, 3]. Entiendo que el software, 
            ...
            <p>
              ...
              de <strong>trabajo en equipo</strong> y el aprendizaje colaborativo[cite: 3]. Busco siempre mejorar 
        ...
        <div className="skills-sidebar">
          <div className="skill-card">
            <h3>Backend</h3>
            <p>Java, JavaScript, NestJS, PHP[cite: 1, 3].</p>
          </div>
          <div className="skill-card">
            <h3>Bases de Datos</h3>
            <p>MySQL, PostgreSQL y SQLite[cite: 1].</p>
          </div>
          <div className="skill-card">
            <h3>Documentación</h3>
            <p>OpenAPI (Swagger), Markdown y Gherkin[cite: 1].</p>
          </div>
          <div className="skill-card">
            <h3>Soft Skills</h3>
            <p>Trabajo en equipo, Adaptación y Mediación[cite: 1, 3].</p>
          </div>
        </div>
